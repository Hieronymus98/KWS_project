...
DATA_PATH = "data.json"
SAVED_MODEL_PATH = "DSCNN_model.h5"
EPOCHS = 40  # paper->20K
BATCH_SIZE = 100
PATIENCE = 5
...
def DSC(model, n_feature, k, s):
    # model.add(tf.keras.layers.Reshape((model.output_shape[1], -1)))
    model.add(tf.keras.layers.SeparableConv2D(n_feature, kernel_size=(k,k), strides=(s, s), activation='relu'))
